					...
					<div class="item wow fadeInDown animated" data-wow-delay=".2s">
						<div class="product-box common-cart-box">
							<div class="product-img common-cart-img">
								<div class="image13">
									<a href="<?= $result['friendly_url'];?>" title="<?php echo $result['category_name'];?>">
										<img src="<?php echo get_image('category', $result['category_image'], '300', '300', 'R'); ?>" alt="<?php echo $result['category_name'];?> "
										 title="<?php echo $result['category_name'].subdomain_name();?>">
									</a>
								</div>
							</div>
							<div class="product-info common-cart-info text-center">
								<h2><a class="cart-name" href="<?= $result['friendly_url'];?>" title="<?php echo $result['category_name'].subdomain_name();?>">
										<?php echo $result['category_name'];?> </a></h2>
								<a class="read_btn" href="<?= $result['friendly_url'];?>" title="<?php echo $result['category_name'].subdomain_name();?>">View
									More</a>
							</div>
						</div>
					</div>
