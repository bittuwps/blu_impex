...
<div class="left_sidebar">
    ...
    <form role="form" name="contact-form" class="contact-form" method="post" id="quick_contact" novalidate="novalidate"
        ...
        <div class="form-group" style="margin-bottom:0">
            <div class="g-recaptcha" tabindex="6" data-sitekey="6Lch4J0UAAAAAN_Bt3D9DnBg_JS-1LSYnSa4vjMC" style="transform:scale(0.80);-webkit-transform:scale(0.82);transform-origin:0 0;-webkit-transform-origin:0 0"
                tabindex="7"></div>
        </div>
