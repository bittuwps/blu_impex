<?php
    if(!isset($contact_form_id)){
        $contact_form_id='#contact-submit';
    }
...
<form role="form" name="contact-form" class="contact-form" method="post" id="quick_contact" novalidate="novalidate"
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="form-group" style="margin-bottom:0">
            ...
            <div class="g-recaptcha" tabindex="6" data-sitekey="<?= Captcha_site_key ?>" style="transform:scale(0.80);-webkit-transform:scale(0.82);transform-origin:0 0;-webkit-transform-origin:0 0"
    ...
    <div class="col-lg-6 col-md-6 col-sm-6">
        ...
        <div class="form-group">
            ...
            <button name="submitt" class="read_btn btn-submit" type="submit" tabindex="7" id="<?= $contact_form_id ?>"
