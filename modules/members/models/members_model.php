...
class Members_model extends MY_Model {
  ...
  public function get_wislists($offset = FALSE, $per_page = FALSE, $param = array()) {
    ...
    $opts = array(
        ...
        'joins' => array(array('tblname' => 'wl_wishlists AS wis', 'jclause' => 'wis.products_Id=wp.products_id'), array('tblname' => 'wl_products_media AS pm', 'jclause' => "wp.products_id=pm.products_id AND pm.is_default = 'Y'")),
    );
