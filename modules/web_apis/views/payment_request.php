...
$_POST['return_url'] = base_url() . "web_apis/members/payment_success";
$_POST['state'] = "state";
$_POST['udf1'] = "";
$_POST['udf2'] = "";
$_POST['udf3'] = "";
...
//unset payment status data
$this->session->unset_userdata('post_type');
$this->session->unset_userdata('transactionId');
$this->session->unset_userdata('random_member');
?>
<p>Redirecting...</p>
<center><img src="<?php echo base_url('assets/loader.gif');?>" height="150" width="200"></center>
