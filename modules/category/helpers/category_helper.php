...
if (!function_exists('category_breadcrumbs')) {
    ...
    function category_breadcrumbs($catid, $segment = '')
    {
        ...
        if ($num_rows > 0) {
            ...
            foreach ($query->result_array() as $row) {
                ...
                if (has_child($row['parent_id'])) {
                    ...
                    if (($segment != '' && ($row['category_id'] == $segment) || ($catID == $row['category_id']) && $catType != 'products/detail')) {
                        ...
                        $link_cat[] = '<span class="navigation-pipe">&nbsp;</span><strong>' . $row['category_name'] . '</strong>';

                    } else {

                        $link_cat[] = '<span class="navigation-pipe">&nbsp;</span><a href="' . $link_url . '" title="' . $row['category_name'] . '"> ' . $row['category_name'] . ' </a>';
            ...
            $link_cat[] = '<span class="navigation-pipe">&nbsp;</span><a href="' . $link_url . '" title="Category Lists"> Category Lists </a>';
            ...
            foreach ($query->result_array() as $row) {
                ...
                if (has_child($row['parent_id'])) {
                    ...
                    if (($segment != '' && ($row['category_id'] == $segment) || ($catID == $row['category_id']) && $catType != 'products/detail')) {
                        ...
                        $link_cat[] = '- <span class="navigation-pipe">&nbsp;</span><a href="' . $link_url . '" title="' . $row['category_name'] . '"> ' . $row['category_name'] . ' </a><br />';
