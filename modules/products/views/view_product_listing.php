									...
									<div class="col-lg-4">
										<div class="product_box_1">
											...
											<div class="product_describe">
												<h3><a href="<?php echo site_url($r['friendly_url']); ?>" title="<?php echo $r['product_name']; ?> <?= subdomain_name() ?>">
														<?php echo $r['product_name']; ?></a></h3>
												<a class="read_more more_btn" href="<?php echo site_url($r['friendly_url']); ?>" title="<?php echo $r['product_name']; ?> <?= subdomain_name() ?>">Read
													More</a>
													<?php 
