					...
					<div class="details-image">
						<a href="" class="enqs<?php echo $cat_res['category_id'];?>" onclick="
						 ...
						 data-toggle="modal" data-target="#productID" title="<?php echo $heading_title;?> <?= subdomain_name() ?>">
							...
							<img src="<?php echo get_image('category', $mainImage, '400', '400', 'R'); ?>" title="<?php echo img_alt($heading_title);?>"
							 alt="<?php echo img_alt($heading_title);?>" class="img-responsive mycatimg_<?php echo $cat_res['category_id'];?>">
										...
										<div class="product_box_1">
											<a href="<?php echo base_url($r['friendly_url']); ?>" title="<?php echo $r['product_name']; ?> <?= subdomain_name() ?>">
												<div class="image3">
													...
													<img src="<?php echo get_image('products', @$img->media, '400', '400', 'R'); ?>" title="<?php echo img_alt($r['product_name']); ?> " alt="<?php echo img_alt($r['product_name']); ?>" class="img-responsive mycatimg_<?php echo $r['products_id'];?>" />
												</div>
											</a>
					...
					<?php
    					...
    					foreach ($cat_like as $result) {
						  ?>
							...
							<div class="col-lg-4">
								<div class="product_box_1">
									<a href="<?php echo site_url($result['friendly_url']); ?>" title="<?php echo img_alt($result['category_name']); ?>">
										<div class="image3">
											<img src="<?php echo get_image('category', $result['category_image'], '400', '400', 'R'); ?>" title="<?php echo img_alt($result['category_name']); ?>"
											alt="<?php echo img_alt($result['category_name']); ?>" class="img-responsive mycatimg_<?php echo $result['category_id'];?>">
										</div>
									</a>
