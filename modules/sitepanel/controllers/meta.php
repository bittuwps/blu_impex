...
class Meta extends Admin_Controller
{
	...
	public function __construct()
	{
	 ...
	 public  function index($page = NULL)
	 {
            ...
            $res_array = $this->db->query("SELECT * FROM wl_meta_tags WHERE is_fixed='N' ORDER BY meta_id DESC")->result_array();
...
//			}
		...
		public function add()
		{
			...
			$this->form_validation->set_rules('meta_title','Title','trim|required|xss_clean|max_length[500]');
			$this->form_validation->set_rules('meta_keyword','Keyword','trim|required|xss_clean|max_length[500]');
			$this->form_validation->set_rules('meta_description','Description','trim|required|xss_clean|max_length[500]');
