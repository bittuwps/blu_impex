  ...
  <div class="row">
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-body">                                                                                         <?php echo form_open_multipart("sitepanel/themes/add/", 'class="form-horizontal"'); ?>  
          <div id="tab_pinfo">
            <div class="row">
              <div class="col-md-10 col-md-offset-1">
                ...
                $default_params = array(
                    'heading_element' => array(
                        ...
                        'field_placeholder' => "Your Theme Name",
                        'exparams' => 'size="40"'
                    ),
                    'url_element' => array(
                ...
                <div class="form-group">
                  <label class="col-md-3 control-label">Theme Image</label>
                  <div class="col-md-9">                                                                                           <input type="file" class="fileinput btn-primary" name="themes_image"  title="Browse file" />
                    <br />
                    <br />
