...
<div class="page-title">                    
  ...
  <a href="<?php echo base_url("sitepanel/subloccontent/add"); ?>" class="btn btn-primary pull-right">Add Standard Main Sudomain Content</a>
</div>
                ...
                <tbody>
                  ...
                  foreach ($res as $catKey => $pageVal) {
                    ...
                    <tr>
                              ...
                              <div class="modal-body">
                                ...
                                foreach($cat as $cval){
                                  ...
                                  <div class="col-md-3 cols-sm-3">
                                    <?php
                                    echo '<b>('.$slLoc.').</b> '.ucwords(get_db_field_value('wl_meta_tags','page_url',"WHERE meta_id = '".$cval."'"));
                                    ?>
                                  </div>
                                  <?php                                  
                                  $slLoc++;
                      ...
                      <td>
                        <?php echo anchor("sitepanel/subloccontent/edit/$pageVal[subcontentId]/" . query_string(), '<span>Edit</span>', 'class="btn btn-info"'); ?>
                      </td>
                    </tr>
                    <?php
                  }
