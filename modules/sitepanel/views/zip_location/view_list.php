...
<div class="page-title">
  ...
  <div class="buttons"><?php echo anchor("sitepanel/zip_location/add/", "<span>Add Zip Location</span>", 'class="btn btn-primary pull-right" '); ?></div>
</div>
<div class="page-content-wrap">
  ...
  <?php echo form_open_multipart("sitepanel/zip_location", 'id="form"'); ?>
            <table class="table datatable" width="55%" align="center" bgcolor="#999999" border="0" cellspacing="1" cellpadding="3" >
              <tr bgcolor="#FFFFFF">
                <th align="left"><strong style="font-size:14px">Bulk Upload - Location</strong></th>
              </tr>
              <tr bgcolor="#FFFFFF">
                ...
                <tbody>
                  ...
                  foreach ($res as $catKey => $pageVal) {
                    ...
                    <tr>
                      ...
                      <td><?php echo $pageVal['location_name']; ?></td>
                      <td><?php echo $pageVal['zip_code']; ?></td>
                      <td><?php echo ($pageVal['cod'] == 'N') ? "Not Available" : "Available"; ?></td>
                      <td><?php echo ($pageVal['status'] == 1) ? "Active" : "In-active"; ?></td>
                      <td><?php echo anchor("sitepanel/zip_location/edit/$pageVal[zip_location_id]/" . query_string(), '<span>Edit</span>', 'class="btn btn-info"'); ?></td>
                    </tr>
                    <?php
                    $j++;
                  }
  ...
  <div id="content">
    ...
    <div class="box">
      ...
      <div class="content">   
        ...
        <?php echo form_open("sitepanel/zip_location/", 'id="search_form" method="get" '); ?>
