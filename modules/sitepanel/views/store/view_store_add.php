...
<div class="page-title">
  ...
  <div class="buttons pull-right col-md-2">
    ...
    <a href="<?php echo base_url('sitepanel/store'); ?>"  class="btn bg-red pull-left">Cancel</a>  
  </div>
</div>
<div class="page-content-wrap">
  <div class="row">
    <div class="col-md-12">
      <?php echo form_open_multipart('sitepanel/store/add/', array('id' => 'form', 'class' => "form-horizontal")); ?>
      <div class="panel panel-default tabs">
        <ul class="nav nav-tabs" role="tablist">
          <li class="active"><a href="#tab-general" role="tab" data-toggle="tab">Add Location</a></li>
        </ul>
        <div class="panel-body tab-content">
          <div class="tab-pane active" id="tab-general">
              ...
              <div class="col-md-6">                          
                <select name="location_id" class="form-control">
                  ...
                  foreach ($location as $k => $v) {
                    $sel = ($this->input->post('location_id') == $v['id'])?'selected':'';
                    ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">                                            
                <input type="text" name="store_name" class="form-control" value="<?php echo set_value('store_name'); ?>" />
