...
<div class="page-title">                    
  ...
  <div class="buttons">
    <a href="<?php echo base_url(); ?>sitepanel/store/add/" class="btn btn-primary pull-right">Add Store</a>
  </div>
</div>
<!-- END PAGE TITLE -->               
        ...
        <div class="panel-body">
          <div class="table-responsive">
            ...
            if (is_array($res) && !empty($res)) {
              echo form_open("sitepanel/store/", 'id="data_form"');
              ?>
              <table class="table datatable" id="my_data">
                ...
                <tbody>
                  ...
                  foreach ($res as $catKey => $pageVal) {
                    $location = $this->db->query("SELECT country_name FROM tbl_country WHERE id = '" . $pageVal['location_id'] . "'")->row_array();
                    ?>
                    <tr>
                      ...
                      <td>
                        <?php echo $pageVal['store_name']; ?>                    
                      </td>
                      <td><?php echo $location['country_name']; ?></td>
                      <td class="left" valign="top"><?php echo ($pageVal['status'] == 1) ? "Active" : "In-active"; ?></td>
                      <td align="center" valign="top">
                        <p >                    
                          <?php echo anchor("sitepanel/store/edit/$pageVal[setId]/" . query_string(), "<span>Edit</span>", 'class="btn btn-info" '); ?> 
                        </p>
                      </td>
                    </tr>
                  <?php } ?>
