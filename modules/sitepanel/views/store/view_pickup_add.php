...
<div class="page-title">
  ...
  <div class="buttons pull-right col-md-2">
    ...
    <a href="<?php echo base_url('sitepanel/store/pickup_point'); ?>"  class="btn bg-red pull-left">Cancel</a>  
  </div>
</div>
<div class="page-content-wrap">
  <div class="row">
    <div class="col-md-12">
      <?php echo form_open_multipart('sitepanel/store/add_point/', array('id' => 'form', 'class' => "form-horizontal")); ?>
      <div class="panel panel-default tabs">
        <ul class="nav nav-tabs" role="tablist">
          <li class="active"><a href="#tab-general" role="tab" data-toggle="tab">Add Pickup Point</a></li>
        </ul>
        <div class="panel-body tab-content">
          <div class="tab-pane active" id="tab-general">
            <div class="form-group">
              ...
              <div class="col-md-6">                                            
                <input type="text" name="pickup_name" class="form-control" value="<?php echo set_value('pickup_name'); ?>" />
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">                                            
                <input type="text" name="pickup_city" class="form-control" value="<?php echo set_value('pickup_city'); ?>" />
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">                                            
                <textarea name="pickup_address" class="form-control"><?php echo set_value('pickup_name'); ?></textarea>
