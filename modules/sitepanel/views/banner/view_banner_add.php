...
<div class="page-title">
    <h2><span><?php echo $heading_title;?></span></h2><div class="buttons">
...
<div class="page-content-wrap">                
    ...
    <div class="row">
		...
		?>
		<?php echo form_open_multipart('sitepanel/banners/add/', 'class="form-horizontal"');?>
            
            <div class="form-group">
                <label class="col-md-3 col-xs-12 control-label"><span class="required">*</span>Section</label>
                <div class="col-md-6 col-xs-12">
                    
                    <select class="form-control" name="section"  onchange="change_ban_postions(this.value);">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-xs-12">                                                                                          <input type="text" name="ban_title" id="ban_title" class="form-control" value="<?php echo set_value('ban_title')?>" />                                                  
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-3 col-xs-12 control-label"><span class="required">*</span>Banner URL</label>
                <div class="col-md-6 col-xs-12">                                                                                          <input type="text" name="url" id="url" class="form-control" value="<?php echo set_value('url')?>" /> (e.g http://wwww.google.co.in)                                                    
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-6 col-xs-12">                                                                                          <input type="submit" name="sub" value="Add Banner" class="btn btn-primary pull-right" />
