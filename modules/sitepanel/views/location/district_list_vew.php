<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><?php echo anchor("sitepanel/" . $this->current_controller . "/district_add_edit", "<span>Add District</span>", 'class="button" '); ?></div>
    </div>

    <div class="content">
      <?php echo error_message(); ?>

      <?php echo form_open("sitepanel/" . $this->current_controller . "/district", 'id="search_form" method="get" '); ?>
      <div align="right" class="breadcrumb"> Records Per Page : <?php echo display_record_per_page(); ?> </div>

      <table width="100%"  border="0" cellspacing="3" cellpadding="3" >
        <tr>
          <td align="center" >
            Search [ District Name ] <input type="text" name="keyword" value="<?php echo $this->input->get_post('keyword'); ?>"  />&nbsp;
            <select name="status">
...
if (is_array($res) && !empty($res)) {
        ...
        <table class="list" width="100%" id="my_data">
          <thead>
            <tr>
              ...
              <td width="239" class="left">District Name </td>
  ...
  foreach ($res as $catKey => $pageVal) {
    ...
    <?php echo get_db_field_value("tbl_states", "title", array("id" => $pageVal['state_id'])); ?>								
                ...
                <td align="center" >
                  <?php echo anchor("sitepanel/" . $this->current_controller . "/district_add_edit/$pageVal[id]/" . query_string(), 'Edit'); ?>
                </td>
              </tr>
                  <?php
                }
