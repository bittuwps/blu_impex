          ...
          <table width="90%"  class="form"  cellpadding="3" cellspacing="3">
            ...
            <tr class="trOdd">
              ...
              <td width="72%" align="left">
                ...
                echo common_dropdown('country_id', set_value('country_id', @$row->country_id), $arr, 'style="width:235px;" onchange="bind_data(this.value,\'sitepanel/location/bind_state\',\'state_list\',\'loader_state\',\'district_section\');"');
                ?>
              </td>
            </tr>
            <tr class="trOdd">
            ...
            <tr class="trOdd">
              <td width="28%" height="26" align="right" ><span class="required">*</span> District Name:</td>
