...
<div class="page-title">                    
    ...
    <a href="<?php echo base_url("sitepanel/location/city_add");?>" class="btn btn-primary pull-right">Add New City</a> 
...
<div class="page-content-wrap">                
    ...
    <div class="row">
        <div class="col-md-12">
			...
			{
				echo form_open("sitepanel/location/city",'id="data_form"','"class=form-horizontal"');?>
				...
				<table class="table dataTable" id="my_data">
					...
					foreach($res as $catKey=>$pageVal)
					{
						...
						<tr>
							...
							<td >
								<?php echo anchor("sitepanel/location/city_edit/$pageVal[id]/".query_string(),'<span>Edit</span>', 'class="btn btn-info"'); ?>
							</td>
						</tr>
						<?php
					}
