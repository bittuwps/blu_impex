  ...
  <div class="breadcrumb">
    ...
    <div class="content"> 
      ...
      <div id="tab-general">
            ...
            <?php if(!empty($res['size_chart'])){?>
            <tr class="trOdd">
			  
                          
                <td colspan="2" align="center">     
                              <div>
                                  <img src="<?php echo base_url('uploaded_files/products/size_chart/'.$res['size_chart']);?>" style="height:200px;width:350px;"/> 
                              </div>  
            ...
            <?php };?>
			  ...
			  <td width="38%" height="26" align="right" >Product Title:</td>
                          <td align="left"><input type="text" name="ptitle" id="ptitle" maxlength="100" size="50" value="<?php echo set_value('ptitle',$res['product_title']);?>" />
      ...
      <tr class="trOdd">
		    ...
		    <tr class="trOdd">
				...
				<td align="left">
					<!--input type="radio" name="video_type" value="embed" class="video_type" <?php echo set_value('video_type',$res['video_type'])=='embed' ? 'checked="checked"' : '';?>/-->
					<input type="radio" name="video_type" value="file" class="video_type" <?php echo set_value('video_type',$res['video_type'])=='file' ? 'checked="checked"' : '';?> />File
