...
<div class="page-title">                    
  ...
  if ($ref_id > 0) {
    ?>
    <div class="buttons">
      <a href="<?php echo base_url(); ?>sitepanel/product_reviews/add/<?php echo $this->input->get('ref_id'); ?>" class="btn btn-primary pull-right">Add Review</a>
    </div>
    <?php
  }
  ?>
...
<div class="page-content-wrap">                
  ...
  if ($ref_id > 0) {
    ...
    echo '<b style="margin-left:10px;">Overall Rating:</b> ' . rating_html($overall_rating, 5);
  }
  ?>
  <div class="fix"></div>
  <div class="row">
              ...
              <table class="table datatable" width="100%" id="my_data">
                <thead>
                  <tr>
                    ...
                    <td><strong>Reviewd By</strong></td>
                ...
                <tbody>
                  ...
                  foreach ($res as $catKey => $val) {
                    ...
                    <tr>
                      ...
                      <td><?php echo $val['author']; ?><br /><?php echo $val['author_email']; ?></td>
                      <td>
    ...
    <div id="content">
      ...
      <div class="box">
        ...
        <div class="content">
          ...
          <?php echo form_open("sitepanel/product_reviews", 'id="search_form" method="get" '); ?>
              ...
              <tbody>
                ...
                foreach ($res as $catKey => $val) {
                  ...
                  <tr>
                    <td><input type="checkbox" name="arr_ids[]" value="<?php echo $val['review_id']; ?>" /></td>
                    <td><?php
                      echo anchor_popup('sitepanel/products/details/' . $val['entity_id'], $val['product_name'], $atts);
                      ;
                      ?></td>
