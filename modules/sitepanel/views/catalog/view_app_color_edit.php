...
<div class="page-title">
    ...
    <div class="buttons"><?php echo anchor("sitepanel/sm_app_color/", '<span><i class="fa fa-remove"></i> Cancel</span>', 'class="btn bg-red pull-right" '); ?></div>
</div>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">                                                                                                        
					...
					<input type="hidden" name="color_id" value="<?php echo $edit_result['bg_id'];?>">
                                </div>
                            </div>
                        </div>
                    <?php echo form_close();?>
