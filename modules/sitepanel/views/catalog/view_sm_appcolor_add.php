...
<div class="page-title">
    ...
    <div class="buttons"><?php echo anchor("sitepanel/sm_color_app/", '<span><i class="fa fa-remove"></i> Cancel</span>', 'class="btn bg-red pull-right" '); ?></div>
</div>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">                                                                                                        
                    ...
                    <?php echo form_open_multipart("sitepanel/sm_app_color/add/", 'class="form-horizontal"'); ?>  
