	...
	foreach($outer_loop as $key1=>$val1)
	{
	  if(!empty($inner_loop))
	  {
		...
		?>
		  ...
		  <td>
                  <input type="text" name="quantity[]" value="<?php if(isset($pro_base_val)){echo substr($pro_base_val->product_qty,0,1);}else{ echo $loop_quantity;}?>" />
		  <?php
		...
		<td>
                  <input type="text" name="product_price[]" value="<?php if(isset($pro_base_val)){echo $pro_base_val->product_price;}else{ echo $loop_product_price;}?>" />
		  <?php
		...
		<td>
                  <input type="text" name="product_discounted_price[]" value="<?php if(isset($pro_base_val)){echo $pro_base_val->product_discounted_price;}else{ echo $loop_product_discounted_price;}?>" />
		  <?php
