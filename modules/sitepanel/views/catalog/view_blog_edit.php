        ...
        <div class="panel-body tab-content">
          ...
          <div class="tab-pane active" id="tab-general">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">                                            
                <input type="text" name="article_title_p" class="form-control"size="70" value="<?php echo set_value('article_title_p',$res['article_title_p']); ?>" />
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">                                            
                <input type="text" name="blog_author" class="form-control"size="70" value="<?php echo set_value('blog_author', $res['blog_author']); ?>" />
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-xs-12">                                            
                <textarea style="width: 70%;" name="short_desc" rows="5" cols="70" id="short_desc" ><?php echo set_value('short_desc', $res['short_desc']); ?></textarea>
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-3 col-xs-12 control-label">Short Description Portuguese</label>
              <div class="col-md-6 col-xs-12">                                            
                <textarea style="width: 70%;" name="short_desc_p" rows="5" cols="70" id="short_desc_p" ><?php echo set_value('short_desc_p',$res['short_desc_p']); ?></textarea>
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-3 col-xs-12 control-label">Description</label>
              <div class="col-md-6 col-xs-12">                                            
                <textarea name="article_desc" rows="5" cols="50" id="article_desc" ><?php echo set_value('article_desc', $res['article_desc']); ?></textarea> <?php echo display_ckeditor($ckeditor); ?>
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-3 col-xs-12 control-label">Description in Portuguese</label>
              <div class="col-md-6 col-xs-12">                                            
                <textarea name="article_desc_p" rows="5" cols="50" id="article_desc_p" ><?php echo set_value('article_desc_p',$res['article_desc_p']); ?></textarea> <?php echo display_ckeditor($ckeditor1); ?>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="buttons pull-right col-md-2">
              <input type="submit" name="sub" value="Save" class="btn btn-primary pull-right" onclick="$('#form').submit();">
