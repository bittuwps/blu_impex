...
<div class="page-title">                    
    ...
    <div class="buttons">
        <a href="<?php echo base_url(); ?>sitepanel/color/add/<?php echo $this->uri->segment(4, 0); ?>" class="btn btn-primary pull-right">Add Color</a>
...
<!--                    <td>
					...
					<td>
						<?php echo anchor("sitepanel/color/edit/$pageVal[color_id]/".query_string(),'<span>Edit</span>', 'class="btn btn-info"'); ?> 
					</td>
				</tr>
			<?php
			}		   
