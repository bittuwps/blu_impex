...
<div class="page-title">
  ...
  <div class="buttons"><?php echo anchor("sitepanel/brands/", '<span>Cancel</span>', 'class="btn btn-primary pull-right" '); ?></div>
</div>
              ...
              <div class="col-md-10 col-md-offset-1">
                ...
                $default_params = array(
                    'heading_element' => array(
                        ...
                        'field_value' => $catresult['brand_name'],
                        'field_placeholder' => "Your Brand Name",
                        'exparams' => 'size="40"',
                        'cat_id' => $catresult['brand_id']
                    ),
                    'url_element' => array(
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3">                                                                                                   <input type="file" class="fileinput btn-primary" name="brands_image" />
                  </div>
                  <div class="col-md-3">
                    <?php
                    if ($catresult['brand_image'] != '' && file_exists(UPLOAD_DIR . "/brands/" . $catresult['brand_image'])) {
                      ?>
                      <a href="#" data-toggle="modal" data-target=".pop-up-1">
                        <img src="<?php echo base_url() . 'uploaded_files/brands/' . $catresult['brand_image']; ?>" width="150" class="img-responsive img-rounded center-block" alt="">
                      </a>
                    </div>
                  </div>
                  <?php 
                ...
                <div class="form-group">
                  <div class="col-md-6 col-md-offset-3">
                    ...
                    <input type="hidden" name="brand_id" id="pg_recid" value="<?php echo $catresult['brand_id']; ?>">
                  </div>
                </div>                      
              </div>
            </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <img src="<?php echo base_url() . 'uploaded_files/brands/' . $catresult['brand_image']; ?>" class="img-responsive img-rounded center-block" alt="">
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
