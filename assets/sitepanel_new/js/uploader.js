...
$(document).ready(function () {
  $(".upload_media").fancybox({'type': 'image', 'titlePosition': 'over'});
  ...
  $('#sel_sbt').click(function (e) {
    ...
    var select_str = '<ul class="image_select_list list-inline" style="display:inline;list-style:none;">';
    var img_str = "";
    var img_sptr = "";
    $('.active img[data-class="item_image"]').each(function (m, n) {
      lobj = $(n);
