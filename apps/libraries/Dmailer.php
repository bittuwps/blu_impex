...
class Dmailer {
  ...
  public function __construct() {
    ...
    $config = array(
        'protocol' => 'smtp',
        'smtp_host' => 'shashikant@webpulseindia.com',
        'smtp_port' => 587,
        'smtp_user' => 'shashikant@webpulseindia.com',
        'smtp_pass' => 'shashi@0403',
        'smtp_crypto' => 'tls'
    );
  ...
  public function mail_notify($mail_conf = array()) {
    ...
    if (is_array($mail_conf) && !empty($mail_conf)) {
      ...
      $this->CI->email->from('info@asiana.com', $from_name);
      $this->CI->email->reply_to('info@asiana.com', $from_name);
