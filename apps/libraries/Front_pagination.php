...
class Front_pagination {
  ...
  var $last_tag_open = '&nbsp;';
  var $last_tag_close = '';
  var $cur_tag_open = '<a href="#" class="active">';
  var $cur_tag_close = '</a>';
  var $next_tag_open = '';
  var $next_tag_close = '';
  var $prev_tag_open = '';
...
//	$output .= '<a href="#" class="select">';
  ...
  function getAJAXlink($count, $text, $cls = "") {
    ...
    return "<a href=\"javascript:void(0);\"  class=\"$cls\"  onclick=\"$('html, body').animate({ scrollTop: 0 }, 'slow'); $('" . $this->table . "').fadeTo(100,0.3,function(){ $.post('" . $this->base_url . $count . "', " . $this->additional_param . ", function(data){ $('" . $this->table . "').fadeTo(100,1,function(){var currdata = $( data ).find('" . $this->table . "').html(); $('" . $this->table . "').html(currdata);" . $this->js_rebind . ";}); });}); return false;\">" . $text . '</a>';
  }
