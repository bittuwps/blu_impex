...
$config['allow.file.size'] = '4096'; //In KB
...
$config['product_set_as_config'] = array('' => "Product Set As", 'newarrival_product' => 'New Arrival');

$config['product_unset_as_config'] = array('' => "Product Unset As", 'newarrival_product' => 'New Arrival');

//, 'bestseller_product'=>'Best Seller'

$config['product_set_as_config'] = array('' => "Product Set As", 'newarrival_product' => 'New Arrival', 'popular_product' => 'Hot Deal', 'special_product' => 'Best Seller', 'coming_product' => 'Popular Products');

$config['product_unset_as_config'] = array('' => "Product Unset As", 'newarrival_product' => 'New Arrival', 'popular_product' => 'Hot Deal', 'special_product' => 'Best Seller', 'coming_product' => 'Popular Products');
